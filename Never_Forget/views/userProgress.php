...
<h1 class="colorSecundario titulo text-center mt-4">Progreso del jugador</h1>
  ...
  <div class="container mt-5 mb-5">
    <div class="row">
      <div class="col-sm-4">
        <img src="../assets/img/ordenadorDiamant.png" class="img-fluid" alt="Responsive image" id=imgPC>
      ...
      <div class="col-sm-4">
        <img src="../assets/img/ordenadorApagado.png" class="img-fluid" alt="Responsive image" id=imgPC>
